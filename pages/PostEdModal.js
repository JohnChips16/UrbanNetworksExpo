...
if (operation === 'Ed') {
  ...
  if (id !== null && id !== '') body.id = id;
  if (schoolOrUniversity !== null && schoolOrUniversity !== '') body.schoolOrUniversity = schoolOrUniversity;
  if (degree !== null && degree !== '') body.degree = degree;
  if (specialization !== null && specialization !== '') body.specialization = specialization;
  if (startYear !== null && startYear !== '') body.startYear = startYear;
  if (graduatedYear !== null && graduatedYear !== '') body.graduatedYear = graduatedYear;
} else if (operation === 'Awrd') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (title !== null && title !== '') body.title = title;
  if (associatedWith !== null && associatedWith !== '') body.associatedWith = associatedWith;
  if (issuer !== null && issuer !== '') body.issuer = issuer;
  if (date !== null && date !== '') body.date = date;
  if (desc !== null && desc !== '') body.desc = desc;
} else if (operation === 'cert') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (certName !== null && certName !== '') body.certName = certName;
  if (certAuthority !== null && certAuthority !== '') body.certAuthority = certAuthority;
  if (licenseNum !== null && licenseNum !== '') body.licenseNum = licenseNum;
  if (expire !== null && expire !== '') body.expire = expire;
  if (dateFrom !== null && dateFrom !== '') body.dateFrom = dateFrom;
  if (dateThen !== null && dateThen !== '') body.dateThen = dateThen;
  if (licenseUrl !== null && licenseUrl !== '') body.licenseUrl = licenseUrl;
} else if (operation === 'lang') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (language !== null && language !== '') body.language = language;
  if (proficiency !== null && proficiency !== '') body.proficiency = proficiency;
} else if (operation === 'org') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (orgName !== null && orgName !== '') body.orgName = orgName;
  if (positionHeld !== null && positionHeld !== '') body.positionHeld = positionHeld;
  if (associatedCollegeEtc !== null && associatedCollegeEtc !== '') body.associatedCollegeEtc = associatedCollegeEtc;
  ...
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (projectName !== null && projectName !== '') body.projectName = projectName;
  if (ongoingProject !== null && ongoingProject !== undefined) body.ongoingProject = ongoingProject;
  if (dateNow !== null && dateNow !== '') body.dateNow = dateNow;
  if (dateThen !== null && dateThen !== '') body.dateThen = dateThen;
  if (associateName && associateName.length > 0) body.associateName = associateName;
  if (associateWith !== null && associateWith !== '') body.associateWith = associateWith;
  if (projectUrl !== null && projectUrl !== '') body.projectUrl = projectUrl;
  if (desc !== null && desc !== '') body.desc = desc;
} else if (operation === 'pub') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (title !== null && title !== '') body.title = title;
  if (publisher !== null && publisher !== '') body.publisher = publisher;
  if (pubDate !== null && pubDate !== '') body.pubDate = pubDate;
  if (authors && authors.length > 0) body.authors = authors;
  if (pubUrl !== null && pubUrl !== '') body.pubUrl = pubUrl;
  if (desc !== null && desc !== '') body.desc = desc;
} else if (operation === 'score') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (testName !== null && testName !== '') body.testName = testName;
  if (associatedWith !== null && associatedWith !== '') body.associatedWith = associatedWith;
  if (!isNaN(score)) body.score = score;
  if (testDate !== null && testDate !== '') body.testDate = testDate;
  if (desc !== null && desc !== '') body.desc = desc;
} else if (operation === 'external') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (description !== null && description !== '') body.description = description;
  if (attachment !== null && attachment !== '') body.attachment = attachment;
} else if (operation === 'skill') {
  // Only include non-empty fields in the body
  if (id !== null && id !== '') body.id = id;
  if (skill !== null && skill !== '') body.skill = skill;
  if (description !== null && description !== '') body.description = description;
}

    const response = await fetch(`http://localhost:9000/v1/users/post/attachment?operation=${operation}`, {
      method: 'POST',
      headers: {
